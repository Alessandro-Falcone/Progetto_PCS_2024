...
bool stampaDatiSulFileFrattureParaview(string &percorsoFileFrattureParaview, DFN &Fract){
...
bool stampaDatiSulFileTracceParaview(string &percorsoFileTracceParaview, DFN &Fract){
